...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        ...
        &nbsp;&nbsp;
        <asp:DropDownList ID="CategoryList" runat="server" DataSourceID="CategoryListODS" 
            DataTextField="CategoryName" DataValueField="CategoryID" AppendDataBoundItems="true">
            <asp:ListItem Value="0">select...</asp:ListItem>
        </asp:DropDownList> <%--AppendDataBoundItems="true" is for the select.. prompt line--%>
        &nbsp;&nbsp;
    ...
    <div class="row">
        <asp:GridView ID="ProductList" runat="server" AutoGenerateColumns="False" DataSourceID="ProductListODS" AllowPaging="True" PageSize="5">
            <Columns> <%--delete EditItemTemplate in each controller--%>
                <asp:TemplateField HeaderText="ID" SortExpression="ProductID">                
                    <ItemTemplate>
                        <asp:Label runat="server" Text='<%# Eval("ProductID") %>' ID="Label1"></asp:Label> <%--Eval is read only, one way (use for PK)--%>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Name" SortExpression="ProductName">
                    <ItemTemplate>
                        <asp:Label runat="server" Text='<%# Bind("ProductName") %>' ID="Label2"></asp:Label> <%--Bind is two way, read and display--%>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Supplier" SortExpression="SupplierID">
                    <ItemTemplate>
                        ...
                        <asp:DropDownList ID="SupplierIDList" runat="server" DataSourceID="SupplierIDListODS" 
                ...
                <asp:TemplateField HeaderText="Category" SortExpression="CategoryID">
                    <ItemTemplate>
                        ...
                        <asp:DropDownList ID="CategoryIDList" runat="server" DataSourceID="CategoryListODS" 
                            DataTextField="CategoryName" DataValueField="CategoryID"
                            SelectedValue='<%# Eval("CategoryID") %>' Enabled="false">
                        </asp:DropDownList>
                    </ItemTemplate>
                </asp:TemplateField>
...
<%--HOMEWORK: Add a search by partial name text box, configure ProductListODS to use GetByCategoryAndName that is in ProductController--%>