...
namespace WebApp.SamplePages
{
    public partial class BasicControls : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //To determine if the page is new or post back, use IsPostBack property

            //this method is often used as a general method to reset fields or controls
            // at the start of the page processing
            //The label MessageLabel is used to display messages to the user.
            //Old messages should be removed from this controls on each pass

            //How does one reference a control on the .aspx form?
            //To reference a form control. use control ID name.
            //EACH control is an Object.
            //THEREFORE alter a PROPERTY value.
            ...
            if(!Page.IsPostBack)
            {
                ...
                //(x,y) represents any two entries in your the data collection at any point in time
                //the lamda symbol => basically means "do the following"
                //.CompareTo() is a method that will compare two items and return the result
                //of comparing two items. The result is interpreted by the Sort() to determine
                ...
                //b)assign the value and display portions of the drop-down list to specific properties
                //  of the data class
                ...
                //   list of data within the drop-down list
